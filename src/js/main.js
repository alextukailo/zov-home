...
!function (e, t) {
  ...
  (S.fn.init = function (e, t, n) {
    ...
    if (n = n || j, "string" == typeof e) {
      ...
      if (r[1]) {
        if (t = _instanceof(t, S) ? t[0] : t, S.merge(this, S.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : E, !0)), N.test(r[1]) && S.isPlainObject(t)) for (r in t) {
...
!function (t, e, i, s) {
  ...
  n.Defaults = {
    ...
    this.$stage.empty(), this._items = [], e && (e = _instanceof(e, jQuery) ? e : t(e)), this.settings.nestedItemSelector && (e = e.find("." + this.settings.nestedItemSelector)), e.filter(function () {
    ...
    i = void 0 === i ? this._items.length : this.normalize(i, !0), e = _instanceof(e, jQuery) ? e : t(e), this.trigger("add", {
      content: e,
      position: i
